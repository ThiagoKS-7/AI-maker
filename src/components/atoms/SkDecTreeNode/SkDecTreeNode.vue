...
export default defineComponent({
  ...
  mounted() {
    this.$store.commit("setApiUrl", "/decTree");
  },
  methods: {
    openCode() {
      window.open(
...
<template>
  <div class="table_node">
    <Handle id="dT__handle-top" type="source" :position="Position.Top" />
    <div class="table_margin">
          ...
          <g transform="translate(151.4918975830078, 6.876411437988281)">
            <defs>
              <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style="stop-color: rgb(0, 249, 146)"></stop>
                <stop
                  offset="100%"
                  style="stop-color: rgb(234, 16, 187)"
                ></stop>
              </linearGradient>
            </defs>
      ...
      <h5 class="title">SkLearn Decision Tree</h5>
    </div>
  </div>
  <Handle id="dT__handle-bottom" type="source" :position="Position.Bottom" />
</template>
...
.table_node {
  ...
  .loader {
    ...
    left: 33%;
    opacity: 0.7;
    border: 4px solid #7131ee;
    border-top: 4px solid #00fe6aa9;
    border-radius: 50%;
    filter: drop-shadow(0 0 0.4em cyan);
    width: 12px;
    height: 12px;
